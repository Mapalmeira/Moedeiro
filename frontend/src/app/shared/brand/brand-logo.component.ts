...
@Component({
  ...
  standalone: true,
  template: `
    <span class="brand" role="img" aria-label="Moedeiro">
  ...
  styles: `
    ...
    .brand__wordmark { font-size: clamp(3rem, 5.4vw, 4.5rem); font-weight: 850; letter-spacing: -.055em; line-height: .95; }
    @media (max-width: 480px) {
      .brand__icon { width: 56px; height: 56px; }
      .brand__wordmark { font-size: 2.8rem; }
    }
  `,

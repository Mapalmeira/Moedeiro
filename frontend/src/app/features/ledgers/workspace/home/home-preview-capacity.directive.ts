...
/** Reports how many whole preview rows fit in a Home dashboard list. */
@Directive({ selector: '[appHomePreviewCapacity]', standalone: true })
export class HomePreviewCapacityDirective {

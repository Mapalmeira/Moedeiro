...
def register_user(unit_of_work_factory: Callable[[], RegistryUnitOfWork], password_hasher: PasswordHasher, invitation_uuid: UUID, name: UserName, password: Password, timestamp: int) -> User:

...
class Settings(BaseModel):
    ...
    external_access_operations_rate_limit: str = Field(default="100/minute", min_length=1)
    ...
    @field_validator("registration_ip_attempts_rate_limit", "login_ip_attempts_rate_limit", "password_recovery_ip_attempts_rate_limit", "totp_setup_ip_attempts_rate_limit", "refresh_ip_attempts_rate_limit", "authenticated_user_operations_rate_limit", "external_access_operations_rate_limit")
    @classmethod
    ...
    def from_environment(cls, environment: Mapping[str, str] | None = None) -> Self:
        ...
        optional_variable_names = {
            ...
            "external_access_operations_rate_limit": "EXTERNAL_ACCESS_OPERATIONS_RATE_LIMIT",
